...
public class UserRecord extends UpdatableRecordImpl<UserRecord> {
     ...
     */
    public UserRecord(String id, String username, String email, String passwordHash, String role, String createdAt) {
        super(User.USER);
     ...
     * Create a detached, initialised UserRecord
     */
    public UserRecord(com.dink3.jooq.tables.pojos.User value) {
        super(User.USER);
