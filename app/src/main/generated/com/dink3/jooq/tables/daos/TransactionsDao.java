...
public class TransactionsDao extends DAOImpl<TransactionsRecord, com.dink3.jooq.tables.pojos.Transactions, Integer> {
    ...
    @Override
    public Integer getId(com.dink3.jooq.tables.pojos.Transactions object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.dink3.jooq.tables.pojos.Transactions> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.dink3.jooq.tables.pojos.Transactions> fetchById(Integer... values) {
     ...
     */
    public com.dink3.jooq.tables.pojos.Transactions fetchOneById(Integer value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.dink3.jooq.tables.pojos.Transactions> fetchOptionalById(Integer value) {
