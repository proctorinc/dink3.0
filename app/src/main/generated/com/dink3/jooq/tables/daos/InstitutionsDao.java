...
public class InstitutionsDao extends DAOImpl<InstitutionsRecord, com.dink3.jooq.tables.pojos.Institutions, String> {
    ...
    @Override
    public String getId(com.dink3.jooq.tables.pojos.Institutions object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.dink3.jooq.tables.pojos.Institutions> fetchRangeOfId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.dink3.jooq.tables.pojos.Institutions> fetchById(String... values) {
     ...
     */
    public com.dink3.jooq.tables.pojos.Institutions fetchOneById(String value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.dink3.jooq.tables.pojos.Institutions> fetchOptionalById(String value) {
