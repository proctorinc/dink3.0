...
public class AccountsDao extends DAOImpl<AccountsRecord, com.dink3.jooq.tables.pojos.Accounts, String> {
    ...
    @Override
    public String getId(com.dink3.jooq.tables.pojos.Accounts object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.dink3.jooq.tables.pojos.Accounts> fetchRangeOfId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.dink3.jooq.tables.pojos.Accounts> fetchById(String... values) {
     ...
     */
    public com.dink3.jooq.tables.pojos.Accounts fetchOneById(String value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.dink3.jooq.tables.pojos.Accounts> fetchOptionalById(String value) {
